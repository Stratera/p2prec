...
public class UserProfileService {
	 ...
	 * @since Aug 24, 2016
	 */
	private com.strateratech.dhs.peerrate.rest.contract.UserProfile mapDbUserProfileToWebUserProfile(
			UserProfile dbObj) {
	 ...
	 * @since Aug 24, 2016
	 */
	private com.strateratech.dhs.peerrate.rest.contract.Department mapDbDepartmentToWebDepartment(
	 ...
	 */
	@Transactional
	public com.strateratech.dhs.peerrate.rest.contract.UserProfile save(
			com.strateratech.dhs.peerrate.rest.contract.UserProfile user, String username) {
	...
	private UserProfile mapWebUserToDbUser(com.strateratech.dhs.peerrate.rest.contract.UserProfile user,
			String username) {
		UserProfile dbUser = null;
		Date now = new Date();
		if (user != null) {
			...
			if (user.getDepartment() != null && user.getDepartment().getName() != null) {
				user.setDepartment(departmentService.mapDbDepartmentToWebDepartment(
	...
	/**
	 * List DB UserProfile objects and convert them to list of UserProfileRest
	 * Contract objects
	 * 
	 * @return
	 */
	public List<com.strateratech.dhs.peerrate.rest.contract.UserProfile> listUserProfiles() {
		List<com.strateratech.dhs.peerrate.rest.contract.UserProfile> list = new ArrayList<>();
		List<UserProfile> dbList = (List<UserProfile>) userProfileRepository.findAll(new Sort(Sort.Direction.ASC, DEFAULT_SORT_FIELD));
		for (UserProfile dbObj: dbList) {
			list.add(mapDbUserProfileToWebUserProfile(dbObj));
		}
		return list;
	}
}
